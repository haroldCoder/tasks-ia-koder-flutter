      ...
      builder: (context) => Container(
        padding: EdgeInsets.symmetric(horizontal: 10),
          child: PopUp(
            ...
            title: Text("Voice IA", textAlign: TextAlign.start, style: TextStyle(color: Colors.white),),
        bg: Color(0xB0000000),
        actions: [],
        child: VoiceAiview(),
      )),
    ...
    return Overlayfixed(
      ...
      widget: Container(
          decoration: BoxDecoration(
            boxShadow: [
              BoxShadow(
                color: Color(0xFF01FF6B).withOpacity(0.6),
                blurRadius: 16,
                spreadRadius: .5,
                offset: Offset(0, 2),
              ),
          ...
          child: IconButton(
            onPressed: () => openDialogVoice(context),
            icon: Icon(
              Icons.mic,
              color: Color(0xFF00F7A5),
              size: 35,
            ),
            style: ButtonStyle(
              backgroundColor:
