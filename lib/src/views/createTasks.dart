...
class Createtasks extends StatelessWidget {
  ...
  handeChangePriority(value) {
    task.setPriorityValue(value);
  }

  createTask(BuildContext context) async {
    print(task.title_task);
    print(task.value_priority);
    print(task.description);
    TaskService()
        .saveTasks(task.title_task, task.description, task.value_priority);
